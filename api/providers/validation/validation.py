...
# import yaml
from api.providers.validation.schema import PROJECTIONS, FORMATS, RESAMPLING_METHODS
#
# albers = '''
# standard_parallel_1:
#   type: float
...
# TODO make subclass of Cerberus Validator
class MockValidationProvider(object):
    @staticmethod
    def valid_projections():
        out = {}
        for proj in PROJECTIONS:
            out[proj['schema']['name']['allowed'][0]] = proj['schema']
        return out
    ...
    @staticmethod
    def valid_resampling():
        return {'resampling_methods': RESAMPLING_METHODS}
