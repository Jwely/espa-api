...
from api.domain import sensor as sn
from api.providers.ordering import ordering_provider as ordering

import validictory
from validictory.validator import DependencyValidationError
...
class OrderValidatorV0(validictory.SchemaValidator):
    ...
    @staticmethod
    def calc_extent(xmax, ymax, xmin, ymin,
                    ext_units, res_units=None, res_pixel=None):
        """Calculate a good estimate of the number
        of pixels contained in an extent"""
        xdif = 0
        ydif = 0
